...
export default function Hero() {
    const typedName = useTypewriter(profile.name, 55);
            ...
            <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 md:grid-cols-2 md:py-24">
                <div>
                    ...
                    >
                        ...
                        <span className="ml-1 inline-block h-[1em] w-[2px] animate-pulse bg-zinc-900 align-[-2px] dark:bg-white" />
                    </motion.h1>
                    ...
                    <div className="mt-7 flex flex-wrap items-center gap-3">
                        ...
                        <a href={buildWhatsAppLink(profile.name)} target="_blank" rel="noreferrer">
...
/** WhatsApp: الأفضل تستخدم wa.me مع text */
function buildWhatsAppLink(name: string) {
    // ⚠️ لازم profile.links.whatsapp يكون مثل: https://wa.me/XXXXXXXXXXX
    // إذا عندك رقم فقط، خليها تبني الرابط من الرقم
    const base = "https://wa.me/00963959902149"; // عدّليها أو خذيها من profile.links.whatsapp
    const text = encodeURIComponent(`Hi, I’m contacting you from ${name}'s portfolio.`);
    return `${base}?text=${text}`;
}

/** Email: mailto مع subject/body */
function buildMailto(name: string) {
    const to = "elinshaia23@gmail.com"; // الأفضل خليه من profile.links.email بعد إزالة mailto:
